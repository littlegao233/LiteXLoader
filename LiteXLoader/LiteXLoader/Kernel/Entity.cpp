...
bool Raw_HasTag(Actor* actor, string* tag)
{
	return SymCall("?hasTag@Actor@@QEBA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z", bool, Actor*, std::string*)(actor, tag);
}
bool Raw_AddTag(Actor* actor, string* tag)
{
	return SymCall("?addTag@Actor@@QEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z", bool, Actor*, std::string*)(actor, tag);
}
bool Raw_RemoveTag(Actor* actor, string* tag)
{
	return SymCall("?removeTag@Actor@@QEAA_NAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z", bool, Actor*, std::string*)(actor, tag);
}
